  ...
  <div className="flex items-center justify-center space-x-4">
    <div className="flex-shrink-0">
      <svg viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill="#000000" 
        className="h-60 w-60 border-orange-300  border-4 p-4 rounded-xl">
        ...
        <g id="SVGRepo_iconCarrier">
          ...
          <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g id="Dribbble-Light-Preview" transform="translate(-180.000000, -2159.000000)" fill="#F9923E">
    ...
    <div className="space-y-4 pl-8">
      <div>
        <label className="block text-teal-100 font-bold text-2xl">Teljes név:</label>
        <p className="mt-1 ml-2 text-xl text-orange-300">{user.fullname}</p>
      </div>
      <div>
        <label className="block text-teal-100 font-bold text-2xl">Email:</label>
        <p className="mt-1 ml-2 text-xl text-orange-300">{user.email}</p>
      </div>
      <div>
        <label className="block text-teal-100 font-bold text-2xl">Szerepkör:</label>
        <p className="mt-1 ml-2 text-xl text-orange-300">{user.role === 'jobseeker' ? 'Munkavállaló' : 'Munkáltató'}</p>
      </div>
    </div>
  </div>
);
